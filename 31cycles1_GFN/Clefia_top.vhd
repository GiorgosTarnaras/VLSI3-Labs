...
architecture FSM of CLEFIA_128_CORE is
    ...
    signal Clefia_round_o_shifted     : std_logic_vector(127 downto 0);
...
begin
    ...
    Clefia_round_o_shifted <= round_out_shared(31 downto 0) & round_out_shared(127 downto 32);
    U_SIGMA8: CLEFIA_8_DOUBLE_SWAP port map (input => Clefia_round_o_shifted, output => l_sigma8_out);
